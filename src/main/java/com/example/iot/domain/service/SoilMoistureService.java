...
import com.example.iot.infrastructure.repository.SoilMoistureRepository;
...
public class SoilMoistureService {
    ...
    public Set<SoilMoistureView> findAllPageable(Pageable pageable) {
        ...
        return new PageImpl<>(soilMoistureViews, page.getPageable(), page.getTotalElements()).toSet();
    }
